...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bt1.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				if (ed1.getText().toString() != null && checkNet()) {
	 ...
	 * 
	 * 4. Read the stream from the connection 5. Close the connection
	 */

	public String findData(String matchKey) throws MalformedURLException,
	IOException {
		String newFeed = Constants.urlByYear + matchKey;
	...
	/* 
	 * If network is not connected, show dialogue
	 */
	public boolean checkNet() {
		final boolean up = netIsUp();
		if (!up) {
			createShowDialogue();
		}
		return up;
	...
	private void createShowDialogue() {
		...
		builder.setMessage(R.string.net_notup)
